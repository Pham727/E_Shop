...
const ItemContent: React.FC<ItemContentProps> = ({
    ...
    const { handleRemoveProductFromCart, handleCartQtyIncrese, handleCartQtyDecrese } = useCart();
    return (<div
        className=" grid grid-cols-5 text-xs md:text-sm gap-4 border-t-[1.5px]
    border-slate-500 py-4 items-center">
        ...
        <div className="justify-self-center">
            <SetQuantity
                ...
                handleQtyDecrease={() => handleCartQtyDecrese(item)}
            />
        </div>
